...
Пользователь может состоять в нескольких организациях. В токене доступа содержатся сведения о всех этих организациях. 
Информация представлена в виде `KV` коллекции `organization-attribute`. Ключ определяется уникальным идентификатором каждой компании. 
...
В отдельным объекте содержится список всех ролей пользователя, 