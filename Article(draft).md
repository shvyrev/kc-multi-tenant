...
Keycloak из коробки предоставляет полную изоляцию тенантов друг от друга. Полностью исключая любое, даже преднамеренное воздействие на другой тенант. Каждый тенант имеет собственные данные, настройки, Поэтому для реализации multi-tenancy необходимо кастомизировать функционал сервиса. 
...
Это отличный пример, как использовать архитектуру плагинов Keycloak для решения задач, не решаемых его основной функциональностью.
