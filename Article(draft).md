...
Все организации в которых состоит пользователь содержаться в объекте - `organization-attribute`. Разделяются по уникальному идентификатору компании. Содержат список атрибутов компании.
