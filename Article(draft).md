...
- *active-organization* - информация об активной организации и ролях пользователя в этой организации 
- *organization-role* - список ролей пользователя для каждой организации в которой он состоит
