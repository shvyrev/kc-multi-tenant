...
После успешной авторизации попадем в портал организаций.
Клиентская часть разделена на две части:
- профиль пользователя 
- организации
### Профиль пользователя 
Раздел разделен на три части :
- **General** 
- **Signing in**
- **Device activity**

#### General
В этом разделе пользователь может изменить свои персональные данные:
- **email**
- **First name**
- **Last name**
Изменения вступят в силу сразу после нажатия **Save**.
![[CleanShot 2024-05-27 at 16.56.19.png]]

#### Signing in

В этом разделе пользователь сам может добавить двухфакторную аутентификацию.
Для этого нажмем на кнопку **Set up authenticator** .
![[CleanShot 2024-05-27 at 16.58.40.png]]
Потребуется заново аутентифицировать пользователя.
В нашем случае :
```
p : password
```
![[CleanShot 2024-05-27 at 16.59.15 1.png]]

Затем можно выбрать приложение аутентификатор из списка:
- Microsoft Authenticator
- Google Authenticator
- FreeOTP
![[CleanShot 2024-05-27 at 17.01.11.png]]
После прохождения всех необходимых шагов пользователю будет добавлен второй фактор аутентификации.

#### Device activity

В этом разделе отображаются все сессии пользователя. 
![[CleanShot 2024-05-27 at 17.02.53.png]]
