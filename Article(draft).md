...
> посмотреть, как в книге описывается заполнение поля без специальных символов

![[CleanShot 2024-05-23 at 20.22.05.png]]
После этого Keycloak создаст администратора для данной организации. В нашем случае :
...
Теперь добавим пользователя в нашу организацию.
