...
Keycloak из коробки предоставляет полную изоляцию тенантов друг от друга. Полностью исключая любое, даже преднамеренное воздействие на другой тенант. Поэтому для реализации multi-tenancy необходимо кастомизировать функционал сервиса. 
